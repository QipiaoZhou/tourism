		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${orders.orderId }" readonly="readonly">
					</div>
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="10" value="${traveller.travellerGender }"
									readonly="readonly"></td>
								<td><input type="text" size="20"
									value="${traveller.travellerPhoneNum }" readonly="readonly"></td>
								<td><input type="text" size="15"
									value="${traveller.idTypeStr}" readonly="readonly"></td>
								<td><input type="text" size="28"
									value="${traveller.idNum }" readonly="readonly"></td>
							</tr>
						</c:forEach>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.member.memberNickName }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${orders.member.memberName}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${orders.member.memberPhoneNum}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${orders.member.memberEmail}</div>
